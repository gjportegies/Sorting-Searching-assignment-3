...
public class Practicum3 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Woord" + "\t "+ "BM aantal" + " \t" + "BM vergelijk" + "\t "+ "KMP aantal" + " \t" + "KMP vergelijk");
        uitvoeren("het");
        uitvoeren("meisje");
    ...
    public static void uitvoeren(String woord)
    {
        BoyerMoore bm = new BoyerMoore(woord);
        bm.search(deel1());
        bm.search(deel2());
        bm.search(deel3());
       
        KMP kmp = new KMP(woord);
        kmp.search(deel1());
        kmp.search(deel2());
        kmp.search(deel3());
        System.out.println(woord + "\t "+ bm.search(deel4()) + " \t" + kmp.search(deel4()) );
    }
    
   

    public static String deel1() {
        return "Mei\n" +
"\n" +
"Boek I\n" +
"\n" +
...
"";
    ...
    public static String deel2() {
        return "Herman Gorter\n" +
"Mei\n" +
"\n" +
"Boek II\n" +
"\n" +
...
"Zij vloog in 't vuur, dat wijdde als een wak\n";
    ...
    public static String deel3() {
        return "Zich uit in 't ijs, waar Oostewind op blaast.\n" +
...
"Gingen de vlakke wanden: regenboog\n" +//kenny moet poepen en dries is neer gestoken door mei met een drol
...
"\n" +
"Naar Boek I van Mei.\n" +
"Naar Boek III van Mei.";
    }

    public static String deel4() {
        return "Herman Gorter\n"
                + "Mei\n"
                + "\n"
                + "Boek III\n"
